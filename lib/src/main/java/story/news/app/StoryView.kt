...
import story.news.Const.HEADER_INFO_KEY
import story.news.Const.IMAGES_KEY
import story.news.Const.IS_RTL_TAG
import story.news.Const.STARTING_INDEX_TAG
import story.news.app.lib_interface.*
import story.news.app.lib_model.StoryLocal
import story.news.app.lib_model.StoryViewHeaderInfoLocal
import story.news.app.lib_progress.StoriesProgressView
import story.news.app.lib_ui.CustomViewPager
import story.news.app.lib_ui.PullDismissLayout
import story.news.app.lib_ui.ViewPagerAdapter
import java.util.*
...
//        mViewPager.setOnTouchListener { v: View?, event: MotionEvent? -> true }
        ...
        if (onStoryChangedCallback != null) {
            mViewPager.addOnPageChangeListener(object : CustomViewPager.OnPageChangeListener {
